...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = findViewById(R.id.receitas);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "receitas", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            }
        });
        FloatingActionButton fab2 = findViewById(R.id.despesas);
    ...
    public void excluirMovimentacao( RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setTitle("Excluir Movimentacão da Conta");
